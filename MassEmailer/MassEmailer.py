...
if __name__ == "__main__":
    body_text = parse_email_body(f'C:/Users/B11/Desktop/dasd/UMAP_Website/MassEmailer/cuerpo.txt')
    email_address_list = parse_email_addresses(f'C:/Users/B11/Desktop/dasd/UMAP_Website/MassEmailer/direccion.txt', 100)

    for email_address in email_address_list:
        email_message = create_message('Subject', 'umapbot@gmail.com', email_address, body_text, attachments=f"C:/Users/B11/Desktop/dasd/UMAP_Website/img/logo.png")
        send_email('umapbot@gmail.com', 'zwfbkcnwfjvmkrvx', email_message)
        sleep(1)
